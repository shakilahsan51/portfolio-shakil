                ...
                <div class="card">
                  ...
                  @method('PUT')
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <textarea name="sub_title" id="" class="form-control" style="height: 100px">{!! $skill->sub_title !!}</textarea>
                      </div>
                    </div>
...
<script>
    $(document).ready(function(){
      $('#image-preview').css({
        'background-image':'url("{{asset($skill->image)}}")',
